...
class Mog2MotionDetector:
    ...
    def __init__(self,history=500):
        ...
        """
        self.BackgroundSubtractorMOG2 = cv2.createBackgroundSubtractorMOG2(history=history,detectShadows=False)
