...
fourcc = cv2.VideoWriter_fourcc('M','J','P','G') #cv2.CV_FOURCC(*'XVID')
out = cv2.VideoWriter("./cars_original.avi", fourcc, 20.0, (640,480))
out_diff = cv2.VideoWriter("./cars_diff.avi", fourcc, 20.0, (640,480))
out_mog = cv2.VideoWriter("./cars_mog.avi", fourcc, 20.0, (640,480))
out_mog2 = cv2.VideoWriter("./cars_mog2.avi", fourcc, 20.0, (640,480))
...
while(True):
    ...
    mog2_mask = my_mog2_detector.returnMask(frame)
